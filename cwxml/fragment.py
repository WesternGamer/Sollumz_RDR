...
class Archetype(ElementTree):
    ...
    def __init__(self, tag_name: str = "Archetype"):
        ...
        self.gravity_factor = ValueProperty("Unknown48")
        self.max_speed = ValueProperty("Unknown4C")
        self.max_ang_speed = ValueProperty("Unknown50")
        self.buoyancy_factor = ValueProperty("Unknown54")
